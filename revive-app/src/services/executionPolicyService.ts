...
const CAPABILITIES: CapabilityDefinition[] = [
  ...
  { name: 'SEND_APPROVED_EMAIL', description: 'Send the exact approved email through a trusted server gateway.', riskClass: 'external_communication', externalSideEffect: true, requiresApproval: true, requiresProvider: true, costClass: 'governed', allowedAutonomy: [], jurisdictionSensitive: true, audienceSafetySensitive: true, enabled: false },
